...
<div class="alert alert-success alert-styled-left alert-arrow-left alert-bordered">
	...
	<span class="text-semibold">Sukses!</span> &bull; Berhasil Menyetor Transaksi.
</div>
@endif
							...
							<tbody>@foreach ($setor as $s)
								<tr>
									...
									<td class="text-center">
										<a href="{{ url('tu/setor/show/'.$s->tanggal_setor.'/'.$s->id_petugas_setor) }}"><span class="label label-info">Lihat Detail</span></a>
									</td>
