				...
				@endif
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Edit Tahun Ajaran</h5>
						...
						<div class="panel-body">
							...
							<form class="form-horizontal" method="POST" action="{{ url('sarpras/tahunajaran/update/'.$tahunajaran->id_tahun_ajaran) }}">
								<fieldset class="content-group">
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input class="form-control" placeholder="2000/2001..." type="text" name="tahun_ajaran" value="{{ old('tahun_ajaran', $tahunajaran->tahun_ajaran) }}" required="required">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-10">
											<input class="form-control" type="date" name="tanggal_mulai" value="{{ old('tanggal_mulai', $tahunajaran->tanggal_mulai) }}" required="required">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-10">
											<input class="form-control" type="date" name="tanggal_selesai" value="{{ old('tanggal_selesai', $tahunajaran->tanggal_selesai) }}" required="required">
										</div>
									</div>
