...
<div class="content">
	...
	<div class="alert alert-success alert-styled-left alert-arrow-left alert-bordered">
		...
		<span class="text-semibold">Sukses!</span> &bull; Berhasil Mereset Password Admin Ini.
	</div>
	@endif
	...
	<div class="alert alert-success alert-styled-left alert-arrow-left alert-bordered">
		<button type="button" class="close" data-dismiss="alert"><span>×</span><span class="sr-only">Close</span></button>
		<span class="text-semibold">Sukses!</span> &bull; Berhasil Mengubah Data Admin Ini.
	</div>
	@endif
	...
	<div class="panel panel-flat">
		...
		<div class="panel-body">
			...
			<form class="form-horizontal" action="{{ url('superadmin/admin/edit/'.$admin->id) }}">
				<fieldset class="content-group">
					...
					<div class="form-group">
						...
						<div class="col-lg-10">
							<input class="form-control" readonly="readonly" value="<?php echo $admin->nama_petugas;?>" type="text">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-10">
							<input class="form-control" readonly="readonly" value="<?php echo $admin->email;?>" type="text">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-10">
							<a href="{{ url('superadmin/admin/resetpassword/'.$admin->id) }}">
