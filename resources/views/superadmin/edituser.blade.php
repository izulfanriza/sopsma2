...
<div class="content">
	...
	<div class="panel panel-flat">
		...
		<div class="panel-body">
			<!-- Form edit user -->
			<form class="form-horizontal" method="POST" action="{{ url('superadmin/users/update/'.$users->id) }}">
				<fieldset class="content-group">
					...
					<div class="form-group">
						...
						<div class="col-lg-10">
							<input class="form-control" type="text" name="nama_petugas" value="{{ old('nama_petugas',$users->nama_petugas) }}" required>
						</div>
					</div>
