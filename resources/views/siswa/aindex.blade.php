...
<div class="content">
	...
	<div class="alert alert-success alert-styled-left alert-arrow-left alert-bordered">
		...
		<span class="text-semibold">Sukses!</span> &bull; Berhasil Menambah Siswa Baru.
	</div>
	@endif
	...
	<div class="alert alert-success alert-styled-left alert-arrow-left alert-bordered">
		<button type="button" class="close" data-dismiss="alert"><span>×</span><span class="sr-only">Close</span></button>
		<span class="text-semibold">Sukses!</span> &bull; Berhasil Mengimport Data Siswa.
	</div>
	@endif
	...
	<div class="alert alert-success alert-styled-left alert-arrow-left alert-bordered">
		<button type="button" class="close" data-dismiss="alert"><span>×</span><span class="sr-only">Close</span></button>
		<span class="text-semibold">Sukses!</span> &bull; Berhasil Mengubah Data Siswa.
	</div>
	@endif
	...
	<div class="panel panel-flat" style="position: static;">
		<div class="panel-heading">
			...
			<div class="heading-elements">
				<a href="{{ url('sarpras/siswa/add') }}">
					<button type="button" class="btn btn-primary btn-sm legitRipple"><i class="icon-plus3 position-left"></i>Tambah Siswa</button>
				</a>
					<button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#modal_theme_primary"><i class="icon-import position-left"></i>Import Siswa</button>
			</div>
...
<div id="modal_theme_primary" class="modal fade">
	<div class="modal-dialog">
		<div class="modal-content">
			<form method="POST" action="{{ url('sarpras/siswa/import') }}" class="form-horizontal" data-toggle="validator" enctype="multipart/form-data">
				
				<div class="modal-header bg-primary">
					<button type="button" class="close" data-dismiss="modal">&times;</button>
					<h6 class="modal-title">IMPORT SISWA</h6>
				</div>
				...
				<div class="modal-body">
					...
					<div class="form-group">
						...
						<div class="col-lg-4">
							<a href="{{ url('sarpras/siswa/downloadsiswa') }}" class="btn btn-success btn-sm">Export Template <i class="icon-file-download2 position-right"></i></a>
