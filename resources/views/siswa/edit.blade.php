				...
				@endif
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Edit Siswa</h5>
						...
						<div class="panel-body">
							...
							<form class="form-horizontal" method="POST" action="{{ url('sarpras/siswa/update/'.$siswa->nis) }}">
								<fieldset class="content-group">
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input class="form-control" placeholder="386069..." type="text" name="nis" value="{{ old('nis', $siswa->nis) }}" required>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-10">
											<input class="form-control" placeholder="Muhammad Putra..." type="text" name="nama_siswa" value="{{ old('nama_siswa', $siswa->nama_siswa) }}" required>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-10">
											<input class="form-control" placeholder="Jl. Lumba-lumba no 16..." type="text" name="alamat" value="{{ old('alamat', $siswa->alamat) }}" required>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-10">
											<input class="form-control" placeholder="Tegal..." type="text" name="tempat_lahir" value="{{ old('tempat_lahir', $siswa->tempat_lahir) }}" required>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="input-group">
											...
											<input class="form-control" type="date" name="tanggal_lahir" value="{{ old('tanggal_lahir', $siswa->tanggal_lahir) }}" required>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-10">
											<input class="form-control" placeholder="Eny Daryanti..." type="text" name="nama_wali" value="{{ old('nama_wali', $siswa->nama_wali) }}" required>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="input-group">
											...
											<input class="form-control" placeholder="Masukan Email Yang Valid" type="email" name="no_hp_wali" value="{{ old('no_hp_wali', $siswa->no_hp_wali) }}" required>
										</div>
									</div>									
