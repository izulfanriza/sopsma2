							...
							<ul class="icons-list">
								<li class="dropdown">
									...
									<ul class="dropdown-menu dropdown-menu-right">
										<li><a href="{{ url('admin/users/show/'.$row->id) }}"><i class="icon-eye"></i> Lihat User</a></li>
										<li><a href="{{ url('admin/users/delete/'.$row->id) }}" onclick="return confirm('Apakah Anda Yakin Akan Menghapus User Ini?');"><i class="icon-trash"></i> Hapus User</a></li>
									</ul>
								</li>
							</ul>
						</td>
