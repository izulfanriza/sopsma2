				...
				@endif
					...
					<div class="panel panel-flat">
						...
						<div class="panel-body">
							...
							<form class="form-horizontal" method="POST" action="{{ url('admin/users/save') }}">
								<fieldset class="content-group">
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input class="form-control" placeholder="Bambang Sujatmiko" type="text" name="nama_petugas" value="{{ old('nama_petugas') }}" required>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input class="form-control" placeholder="Masukan Email Yang Valid" type="email" name="email" value="{{ old('email') }}" required>
										</div>
									</div>
